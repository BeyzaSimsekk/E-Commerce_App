...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      {/* Sidebar Menu for small screen | Responsiveness */}
      <div
      ...
      >
        <div className="flex flex-col text-gray-500">
          ...
          >
            ...
            <p className=" hover:text-fuchsia-950">Back</p>
          </div>
          <NavLink
            onClick={() => setVisible(false)}
            className="py-2 pl-6 border hover:text-fuchsia-950 hover:bg-[#C586A5] transition-colors duration-200"
            to="/"
          >
            HOME
          </NavLink>
